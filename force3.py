...
from controls.pawn import Pawn
from controls.slot import Slot
...
class Game(ft.Stack):
 ...
 # method that returns the slots of the current horizontal line according to the start_top attribute
    ...
    def show_game_over_dialog(self):
        ...
        since the dialog is associated to the page, we open it from the page then create a new game
        """
        tm.sleep(2)
        global is_game_over
        is_game_over = True
